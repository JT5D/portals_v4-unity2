...
import { CubeTexture, EquirectangularReflectionMapping, LinearSRGBColorSpace, MeshBasicMaterial, Vector3 } from "three";
...
export class ReflectionProbe extends Behaviour {
    ...
    set texture(tex) {
        ...
        this._texture = tex;
        if (debug)
            console.debug("[ReflectionProbe] Set reflection probe texture " + (tex?.name || "(removed)"));
        if (tex) {
