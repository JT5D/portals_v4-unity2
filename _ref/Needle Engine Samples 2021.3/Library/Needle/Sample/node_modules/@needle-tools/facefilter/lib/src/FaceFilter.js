...
import { FacefilterUtils, MediapipeHelper } from './utils.js';
...
export class NeedleFilterTrackingManager extends Behaviour {
     ...
     * @default true
    */
    createRecordingButton = true;
    /** When enabled a share button will be created
     * @default true
    */
    createShareButton = true;
     ...
     */
    getBlendshapeValue(shape, index = 0) {
    ...
    */
    ...
    async startCamera(video, retryCount = 0) {
        // Use camera stream
        ...
        if (isDevEnvironment()) {
            if (this.testVideo && this.testVideo.length > 0) {
                let currentIndex = getParam("testvideo");
    ...
    _states = [];
    _lastTimeOptionsChanged = -1;
    _currentMaxFaces = -1;
    /** The last landmark result received */
    _lastFaceLandmarkResults = null;
    _lastPoseLandmarkResults = null;
    _lastImageSegmentationResults = null;
    earlyUpdate() {
        if (!this._video)
            return;
        if (!this._videoReady)
    ...
    _blendshapeMirrorIndexMap = null;
    /**
    ...
    _buttons = [];
    createUI() {
        if (!this.createMenuButton && !this.createRecordingButton && !this.createShareButton)
            return;
...
__decorate([
    serializable()
], NeedleFilterTrackingManager.prototype, "autoManagePerformance", void 0);
__decorate([
    serializable()
], NeedleFilterTrackingManager.prototype, "urlParameter", void 0);
__decorate([
    serializable()
], NeedleFilterTrackingManager.prototype, "useKeyboard", void 0);
__decorate([
    serializable()
], NeedleFilterTrackingManager.prototype, "maxFaces", void 0);
__decorate([
    serializable(AssetReference)
], NeedleFilterTrackingManager.prototype, "filters", void 0);
__decorate([
    serializable(AssetReference)
], NeedleFilterTrackingManager.prototype, "occlusionMesh", void 0);
__decorate([
    serializable()
], NeedleFilterTrackingManager.prototype, "createOcclusionMesh", void 0);
__decorate([
    serializable()
], NeedleFilterTrackingManager.prototype, "createMenuButton", void 0);
__decorate([
    serializable()
], NeedleFilterTrackingManager.prototype, "createRecordingButton", void 0);
__decorate([
    serializable()
], NeedleFilterTrackingManager.prototype, "createShareButton", void 0);
__decorate([
    serializable(Texture)
], NeedleFilterTrackingManager.prototype, "customLogo", void 0);
__decorate([
    serializable(URL)
], NeedleFilterTrackingManager.prototype, "testVideo", void 0);
class FaceInstance {
    manager;
    ...
    _filter = null;
    _instance = null;
    _filterBehaviour = null;
    _faceIndex = -1;
    update(active, index, _currentFacesCount) {
        if (!active) {
            this.remove();
            return;
        }
...
//# sourceMappingURL=FaceFilter.js.map