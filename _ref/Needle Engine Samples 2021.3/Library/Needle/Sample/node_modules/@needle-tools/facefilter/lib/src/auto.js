import { isDevEnvironment, onStart, showBalloonError } from "@needle-tools/engine";
    ...
    if (facefilterValue) {
        ...
        if (maxFacesAttribute) {
            ...
            if (!isNaN(number)) {
                ...
                console.warn(`Invalid value for "face-filter-max-faces" attribute: "${maxFacesAttribute}". Expected a number`);
        }
        if (isImage(facefilterValue)) {
            let layout = ctx.domElement.getAttribute("face-filter-layout");
            ;
            switch (layout) {
                case "procreate":
                case "mediapipe":
            ...
            let facefilterScale = ctx.domElement.getAttribute("face-filter-scale");
            let facefilterOffsetAttribute = ctx.domElement.getAttribute("face-filter-offset");
...
function updateShowVideo(filter, domElement) {
